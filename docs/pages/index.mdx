...
<div className="mx-0 mt-4 md:mx-4 xl:-mx-12 2xl:-mx-24">
    ...
    <div style={{ marginTop: '1.5rem', paddingTop: '1.5rem' }} className="text-sm opacity-80">
        Looking for product references?<br />
        [Bundler](/references/bundler), [Paymaster](/references/paymaster), [permissionless.js](/references/permissionless)
    </div>
</div>
...
- Follow [@pimlicoHQ](https://twitter.com/pimlicoHQ) and the Pimlico team ([@kristofgazso](https://twitter.com/kristofgazso), [@plusminushalf](https://twitter.com/plusminushalf), [@nikmel2803](https://twitter.com/nikmel2803), [@0xmouseless](https://twitter.com/0xmouseless), [@fastfourier_eth](https://twitter.com/fastfourier_eth)) on Twitter for project updates
