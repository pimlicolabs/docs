...
<div className="mx-0 mt-4 md:mx-4 xl:-mx-12 2xl:-mx-24">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* <div>
            ## [<span className="underline text-yellow-600 hover:text-yellow-800 hover:underline">FlashFund →</span>](/infra/flash-fund)
