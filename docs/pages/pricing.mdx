...
:::info
This pricing will be effective starting from 1 June 2024. Before then, the current pricing of a 10% surcharge on mainnet transactions for the verifying paymaster will be in effect.
:::
