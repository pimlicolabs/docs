...
:::tip
For an example of a more complex, production-ready infaltor contract, see [Daimo's implementation](https://github.com/daimo-eth/bulk/blob/master/src/DaimoOpInflator.sol) which is able to compress their user operation data by over 80%.
:::
