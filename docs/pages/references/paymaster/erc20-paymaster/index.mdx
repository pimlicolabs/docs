...
- Learn how to [use the ERC-20 Paymaster, including the relevant RPC methods as part of your app's flow](/references/paymaster/erc20-paymaster/how-to/use-paymaster).
