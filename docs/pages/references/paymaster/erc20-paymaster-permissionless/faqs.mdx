...
:::info
**Check out our tutorial!** We wrote a [tutorial](/references/permissionless/tutorial/tutorial-2) that takes you through the whole flow of deploying a Safe account and sending your first user operation sponsored with USDC.
:::
...
You can do this either by going to our [ERC-20 Paymaster Contracts](/references/paymaster/erc20-paymaster/contract-addresses) reference page or
...
Do any final touches to your user operation, such as signing, then submit the user operation to a bundler [like ours](/references/bundler/usage) and watch it be included on-chain!
...
Check out our [Getting Started with the ERC-20 Paymaster](/references/permissionless/tutorial/tutorial-2) guide that walks you through deploying your SimpleWallet and getting your first UserOperation sponsored with USDC.
...
You can use permissionless.js to easily interact with the ERC-20 Paymaster. Check out the [documentation](/references/permissionless/how-to/paymasters/use-custom-paymaster) for more information.
