...
This error means that the chain you are trying to sponsor a User Operation on is not supported by Pimlico. You can find the list of supported chains [here](/references/platform/supported-chains). If there is a chain we do not yet support that you would like to see added, [reach out to us](https://t.me/kristofgazso).