...
- You could sponsor all the gas fees, but for a more limited set of user operations using our [sponsorship policies](/references/platform/sponsorship-policies), for instance setting per user sponsorship limits, global spending limits, and more.
...
If you would like to restrict how much you spend, consider taking a look at our [sponsorship policies](/references/platform/sponsorship-policies) that could allow you, for instance, to set a global spend limit of $100,000 no matter what.
