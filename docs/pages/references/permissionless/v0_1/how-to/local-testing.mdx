...
_You are viewing permissionless.js v0.1 documentation. [View the latest documentation →](/references/permissionless)._ This guide walks you through a ready-to-use Docker-based mock ERC-4337 test environment that bundles a local Alto bundler, a mock verifying paymaster, an Anvil node, and all ERC-4337 related contracts — the EntryPoint and account factories for every major smart account implementation.
