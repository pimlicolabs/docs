...
# How to create and use a LightAccount with permissionless.js [Alchemy's SimpleAccount fork with transferrable ownership and upgradability; EntryPoint v0.6 only]
