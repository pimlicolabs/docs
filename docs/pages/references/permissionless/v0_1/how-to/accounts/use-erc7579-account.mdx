...
# How to use an ERC-7579 compatible smart account with permissionless.js [Install and call ERC-7579 modules on Safe or Kernel using the modular account interface]
