...
# Update your existing app to sponsor gas fees for smart account users [Wire an ERC-7677 proxy and EIP-5792 paymaster capability into an existing dapp without embedding a wallet]
