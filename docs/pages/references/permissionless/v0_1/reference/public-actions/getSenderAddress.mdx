...
_You are viewing permissionless.js v0.1 documentation. [View the latest documentation →](/references/permissionless)._ Return a sender address corresponding to the initCode of the User Operation where the smart account will be deployed.
