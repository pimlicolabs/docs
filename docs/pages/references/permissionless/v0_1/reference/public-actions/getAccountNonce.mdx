...
_You are viewing permissionless.js v0.1 documentation. [View the latest documentation →](/references/permissionless)._ Returns the current nonce of the smart account for a specified key. 
