...
_You are viewing permissionless.js v0.1 documentation. [View the latest documentation →](/references/permissionless)._ Estimates the gas values for the User Operation and sponsors the operation with the new gas values.
