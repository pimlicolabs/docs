...
_You are viewing permissionless.js v0.1 documentation. [View the latest documentation →](/references/permissionless)._ Signs the hash of the User Operation with the standard ECDSA signature scheme (used by all EOAs and most smart wallets).
