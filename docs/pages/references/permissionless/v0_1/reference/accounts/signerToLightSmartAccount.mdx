...
_You are viewing permissionless.js v0.1 documentation. [View the latest documentation →](/references/permissionless)._ Creates a LightAccount instance controlled by a `SmartAccountSigner`.
