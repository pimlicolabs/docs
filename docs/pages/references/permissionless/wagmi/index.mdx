...
@permissionless/wagmi is a TypeScript library built on top of permissionless.js and wagmi that enables EIP-5792 features — gas sponsorship via ERC-7677 paymasters and transaction batching — in your wagmi app with just a couple lines of code.
