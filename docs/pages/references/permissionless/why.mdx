...
A summary of why we built permissionless.js — the gaps in existing ERC-4337 tooling, the principles that shaped the library, and how it stays vendor-agnostic while still giving you tight integration with viem.
