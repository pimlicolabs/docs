# Update your existing app to sponsor gas fees for smart account users [Add ERC-7677 paymaster sponsorship to an existing dapp without embedding a wallet]
