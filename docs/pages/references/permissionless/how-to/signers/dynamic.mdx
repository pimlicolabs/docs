# How to use a Dynamic signer with permissionless.js [Embedded wallet with social/email login that drives a smart account as the on-chain signer]
...
Following Dynamic's [quickstart guide](https://www.dynamic.xyz/docs/react-sdk/quickstart), set up the Dynamic provider in your app. Also integrate the DynamicWagmiConnector, which will allow you to use Dynamic as a signer with permissionless.js.
