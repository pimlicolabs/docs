...
# How to use a Para signer with permissionless.js [Cross-app portable MPC wallet via email or social login as a smart account signer]
...
- Refer to the [Para documentation site](https://docs.getpara.com/v2/introduction/welcome) for instructions on setting up an application with the Para.
