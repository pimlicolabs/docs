# How to use an ERC-7579 compatible smart account with permissionless.js [ERC-7579 modular account interface for installing and calling validators and executors]
