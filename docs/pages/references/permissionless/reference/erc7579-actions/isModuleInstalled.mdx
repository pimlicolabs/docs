...
Returns `true` if the specified [ERC-7579](https://eips.ethereum.org/EIPS/eip-7579) module is currently installed on the smart account — useful for gating UI flows or skipping a redundant `installModule` call.
