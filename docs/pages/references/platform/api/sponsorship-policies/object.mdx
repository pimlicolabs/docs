...
The date and time the sponsorship policy will become active formatted as an ISO 8601 string (e.g. `2024-05-23T15:23:38Z`). If `null`, the policy is active immediately.

- **end_time:** `string` or `null`

The date and time the sponsorship policy will become inactive formatted as an ISO 8601 string (e.g. `2024-05-23T15:23:38Z`). If `null`, there is no end time after which the policy is inactive. Must be in the future.
