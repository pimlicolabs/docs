...
Creates a new sponsorship policy in your Pimlico account — including its name, scope (active chains and EntryPoint versions), spending limits, and active time window — via a single `POST` to the platform API.
