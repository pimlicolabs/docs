...
- Advanced [debugging tools](/references/platform/debugging/dropped-user-operations), letting you automatically decode errors and simulate failed user operations
...
- [Sponsorship policies](/references/platform/sponsorship-policies), letting you set fine-grained conditions for which user operations you would like to sponsor, including global, per user, and per user operation spending limits, custom webhook validation, and more
- A [gas grants platform](/references/platform/sponsorship-policies/gas-program), letting you apply for gas grants from our partners to help you get started with smart accounts without having to pay for gas
