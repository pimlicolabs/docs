...
Using the Magic Spen requires having one or many stakes on any connected EVM chains. The staking process is simple and can be done using the block explorer or `cast` CLI.
