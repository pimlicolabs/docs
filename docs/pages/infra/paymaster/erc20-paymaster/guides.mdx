...
When using Pimlico's ERC20-paymaster, the paymaster needs allowance to spend funds on the senders behalf. The amount to approve must be atleast equal to the userOperation's prefund value.
