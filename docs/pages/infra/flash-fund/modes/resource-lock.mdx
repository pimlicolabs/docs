...
Flash FundResource Lock mode is designed for production-scale applications, enabling users to lock their tokens in specialized smart contracts and instantly access ETH across any supported chain through simple message signing.
...
- Optimized for Flash Fund operations
