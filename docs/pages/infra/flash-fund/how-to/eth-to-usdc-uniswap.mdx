...
You can find the complete code example in the [snippets directory](https://github.com/pimlicolabs/pimlico-docs/blob/main/docs/snippets/flash-fund/eth-to-usdc-uniswap.ts).
