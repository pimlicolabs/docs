...
```ts
// [!include ~/snippets/magic-spend/pimlico-lock.ts:flashfund_prepareLock]
```

### Get the stakes

```ts
// [!include ~/snippets/magic-spend/pimlico-lock.ts:flashfund_getLocks]
```

### Prepare the allowance

```ts
// [!include ~/snippets/magic-spend/pimlico-lock.ts:flashfund_prepareAllowance]
```

### Request a withdrawal sponsorship

```ts
// [!include ~/snippets/magic-spend/pimlico-lock.ts:flashfund_sponsorWithdrawal]
```
