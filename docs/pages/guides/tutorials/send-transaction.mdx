# Tutorial — Batch multiple transactions from a smart account [Deploy an ERC-4337 smart account and atomically execute multiple calls in one user operation]
