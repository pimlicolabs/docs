...
Start by going to the [sponsorship policies page](/references/platform/sponsorship-policies) on the Pimlico dashboard and clicking on the "Create Policy" button.
