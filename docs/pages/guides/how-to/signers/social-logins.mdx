...
Each provider below exposes an EOA (or EOA-compatible signer) that you can pass directly as an owner to permissionless.js when creating your smart account.
