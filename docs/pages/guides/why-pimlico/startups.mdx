# Why Pimlico for Startups [Generous free tier, fast onboarding, and multichain bundler/paymaster APIs to ship smart accounts quickly]
...
Some of the best teams in crypto have already chosen to partner with Pimlico. Startups such as [Daimo](https://daimo.com/), [Drakula](https://drakula.app/), [ZeroDev](https://zerodev.app), and enterprises such as [Zora](https://zora.co/), [Safe](https://safe.global), [thirdweb](https://thirdweb.com), and [Consensys](https://consensys.io/) are already among our users. By choosing Pimlico, you would be joining the ranks of some of the best teams in crypto.
