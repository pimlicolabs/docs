...
- **No private key management** - Pimlico handles signing and submission
- **Simplified gas management** - No need to worry about gas price fluctuations
- **High reliability** - Built-in retry mechanisms and monitoring
...
- [Supported Chains](/guides/supported-chains)
- [Platform API Reference](/references/platform/api)