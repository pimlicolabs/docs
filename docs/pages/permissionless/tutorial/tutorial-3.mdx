...
# Tutorial 3 — Submit a user operation with an ERC-20 Paymaster (permissionless)

:::info
You can visit our [ERC-20 Paymaster (Permissionless) overview page](/infra/paymaster/erc20-paymaster-permissionless) to learn more about the design and architecture of our ERC-20 Paymaster, and the deployed smart contract addresses.
:::
...
The recommended way to do this is to use the [USDC faucet](https://usdcfaucet.com/), select 'Sepolia' and enter the counterfactual sender address you generated in the previous step.
