...
Creates a Trust Wallet Smart Account instance controlled by a `owner`.  Check out [this guide](/permissionless/accounts/how-to/use-trustwallet-account) for a complete tutorial.
