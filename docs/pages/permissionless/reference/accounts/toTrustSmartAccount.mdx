...
Creates a Trust Wallet Smart Account instance controlled by a `owner`.  Check out [this guide](/permissionless/accounts/use-trustwallet-account) for a complete tutorial.
