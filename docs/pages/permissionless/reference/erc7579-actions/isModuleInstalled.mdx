...
Checks if an [ERC-7579](https://eips.ethereum.org/EIPS/eip-7579) module is installed on the smart account. Check out [this guide](/permissionless/accounts/how-to/use-erc7579-account) for a complete tutorial.
