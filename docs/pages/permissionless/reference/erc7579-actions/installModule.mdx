...
Installs a [ERC-7579](https://eips.ethereum.org/EIPS/eip-7579) module to the smart account. Check out [this guide](/permissionless/accounts/use-erc7579-account) for a complete tutorial.
