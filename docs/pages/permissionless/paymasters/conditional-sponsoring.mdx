...
```ts
// [!include ~/snippets/paymasters/conditional-sponsoring.ts:client]
```
...
```ts
// [!include ~/snippets/paymasters/conditional-sponsoring.ts:account]
```
...
```ts
// [!include ~/snippets/paymasters/conditional-sponsoring.ts:smart-account-client]
```
