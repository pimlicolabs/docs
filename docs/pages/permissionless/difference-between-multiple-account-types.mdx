...
|-------------------|-----------|----------|-------------------|-----------------------------|-------------------------|
| Safe              | Yes       | Yes      | Yes               | 34,958                     | Various                |
| Kernel            | Yes       | Yes      | Yes               | 133,314 (v3), 771,072 (v2)  | ChainLight, Kalos      |
| Biconomy Nexus    | Yes       | Yes      | Yes               | 314 (Nexus), 224,758 (v2)   | Cyfrin, Spearbit       |
| Simple Smart Acc. | No        | No       | No                | No                  | 1,481,305                  | OpenZeppelin           |
| LightAccount      | No        | No       | No                | 7,323,817                  | QuantStamp             |
| TrustWallet       | No        | Yes      | Yes               | 36,838                     | Independent audits                    |
