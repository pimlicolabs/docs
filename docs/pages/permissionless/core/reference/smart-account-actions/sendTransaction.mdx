...
- If `paymaster: PaymasterClient`, it will use the provided Paymaster Client eg [Pimlico Client](/permissionless/core/reference/clients/pimlicoClient) for sponsorship.
