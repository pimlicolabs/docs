...
Use `smartAccountClient.sendTransaction` instead. It now accepts an array of transactions. Read more about it [here](/permissionless/core/reference/smart-account-actions/sendTransaction#usage).
