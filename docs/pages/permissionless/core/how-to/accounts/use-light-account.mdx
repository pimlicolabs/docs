...
:::info
For a full list of options for creating a LightAccount, take a look at the reference documentation page for [`toLightSmartAccount`](/permissionless/core/reference/accounts/toLightSmartAccount).
:::
