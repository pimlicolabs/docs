...
:::info
For a full list of options for creating a SimpleAccount, take a look at the reference documentation page for [`toSimpleSmartAccount`](/permissionless/core/reference/accounts/toSimpleSmartAccount).
:::
