...
:::info
For a full list of options for creating a SafeAccount, take a look at the reference documentation page for [`toSafeSmartAccount`](/permissionless/core/reference/accounts/toSafeSmartAccount).
:::
