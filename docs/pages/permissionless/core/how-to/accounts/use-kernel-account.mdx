...
:::info
For a full list of options for creating a Kernel account, take a look at the reference documentation page for [`toEcdsaKernelSmartAccount`](/permissionless/core/reference/accounts/toEcdsaKernelSmartAccount).
:::
