...
:::warning
If you are getting `WaitForUserOperationReceiptTimeoutError`. Use custom timeout in transport, please see the [FAQs](/permissionless/core/faqs#getting-waitforuseroperationreceipttimeouterror) for more information.
:::
