...
Creates a KernelAccount instance controlled by a `SmartAccountSigner`.  Check out [this guide](/permissionless/core/how-to/accounts/use-kernel-account) for a complete tutorial.
