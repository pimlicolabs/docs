...
:::info
For a full list of options for creating a SimpleAccount, take a look at the reference documentation page for [`signerToSimpleSmartAccount`](/permissionless/core/v0_1/reference/accounts/signerToSimpleSmartAccount).
:::
