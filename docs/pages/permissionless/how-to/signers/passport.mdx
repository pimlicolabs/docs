...
After following the Passport documentation, you will have access to a Passport `WalletClient` object that you can pass as an owner to `createeSmartAccountClient`, both examples show how to register a user
