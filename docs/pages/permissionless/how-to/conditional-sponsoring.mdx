...
```ts
// [!include ~/snippets/how-to/conditional-sponsoring.ts:client]
```
...
```ts
// [!include ~/snippets/how-to/conditional-sponsoring.ts:account]
```
...
```ts
// [!include ~/snippets/how-to/conditional-sponsoring.ts:smart-account-client]
```
