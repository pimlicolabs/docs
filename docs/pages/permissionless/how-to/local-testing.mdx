...
- An Anvil node
- ERC-4337 related contracts, including the EntryPoint and account factories for all major ERC-4337 account implemnetations.
...
The mock environment is designed to mimic mainnet as closely as possible by building with the latest Alto version and by deploying all contracts (entrypoints, paymaster, smart account factories, etc.)
