...
Creates a Trust Wallet Smart Account instance controlled by a `SmartAccountSigner`.  Check out [this guide](/permissionless/accounts/use-trustwallet-account) for a complete tutorial.
