...
The Safe account will need to have a signer to sign user operations. In permissionless.js, the default Safe account validates ECDSA signatures. [Any permissionless.js-compatible signer](/permissionless/signers) can be used for the Safe account.
...
:::info
For a full list of options for creating a Safe account, take a look at the reference documentation page for [`signerToSafeSmartAccount`](/permissionless/v0_1/reference/accounts/signerToSafeSmartAccount).
:::
