...
```ts
// [!include ~/snippets/v0_1/tutorial-3.ts:clients]
```
...
```ts 
// [!include ~/snippets/v0_1/tutorial-3.ts:smartAccount]
```
...
```ts 
// [!include ~/snippets/v0_1/tutorial-3.ts:checkBalance]
```
...
```typescript
// [!include ~/snippets/v0_1/tutorial-3.ts:smartAccountClient]
```
...
```typescript
// [!include ~/snippets/v0_1/tutorial-3.ts:submit]
```
