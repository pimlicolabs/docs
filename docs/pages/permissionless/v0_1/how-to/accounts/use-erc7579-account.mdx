...
:::info
For a full list of options for creating a SafeAccount, take a look at the reference documentation page for [`signerToSafeSmartAccount`](/permissionless/v0_1/reference/accounts/signerToSafeSmartAccount).
:::
