...
:::info
**Check out our tutorial!** We wrote a [tutorial](/permissionless/tutorial/tutorial-3) that takes you through the whole flow of deploying a Safe account and sending your first user operation sponsored with USDC.
:::
...
You can do this either by going to our [ERC-20 Paymaster Contracts](/paymaster/erc20-paymaster/contract-addresses) reference page or
...
Do any final touches to your user operation, such as signing, then submit the user operation to a bundler [like ours](/bundler/how-to/bundle-a-user-operation) and watch it be included on-chain!
...
Check out our [Getting Started with the ERC-20 Paymaster](/permissionless/tutorial/tutorial-3) guide that walks you through deploying your SimpleWallet and getting your first UserOperation sponsored with USDC.
...
You can find the contract source code [here](https://github.com/pimlicolabs/erc20-paymaster/blob/main/src/ERC20Paymaster.sol).
