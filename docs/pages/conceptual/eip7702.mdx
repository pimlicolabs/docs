...
A full demo showing how to use ERC-4337 with EIP-7702 can be found [here](/references/permissionless/how-to/eip-7702-demo).
...
For a complete guide on how to test EIP-7702, check out our [step-by-step tutorial](/references/permissionless/how-to/eip-7702-demo) which walks through the process of sending a sponsored userOperation from an EOA. You can also find a complete working example in our [7702 UserOp demo repository](https://github.com/pimlicolabs/7702-userop-demo).
