		...
		items: [
			{
				...
				link: "/bundler/how-to/compress-user-operations",
			},
			{ text: "How to Bundle a User Operation", link: "/bundler/how-to/bundle-a-user-operation" },
			{
				text: "How to Estimate the Gas Limits for a User Operation",
				link: "/bundler/how-to/estimate-user-operation-gas-limits",
			},
		],
	},
	{
				...
				items: [
					{
						...
						link: "/bundler/reference/endpoints/eth_sendUserOperation",
					},
					{
						text: "eth_estimateUserOperationGas",
						link: "/bundler/reference/endpoints/eth_estimateUserOperationGas",
					},
					{
						text: "eth_getUserOperationReceipt",
						link: "/bundler/reference/endpoints/eth_getUserOperationReceipt",
					},
					{
						text: "eth_getUserOperationByHash",
						link: "/bundler/reference/endpoints/eth_getUserOperationByHash",
					},
					{
						text: "eth_supportedEntryPoints",
						link: "/bundler/reference/endpoints/eth_supportedEntryPoints",
					},
					{
						text: "pimlico_sendCompressedUserOperation",
						link: "/bundler/reference/endpoints/pimlico_sendCompressedUserOperation",
					},
					{
						text: "pimlico_getUserOperationGasPrice",
						link: "/bundler/reference/endpoints/pimlico_getUserOperationGasPrice",
					},
					{
						text: "pimlico_getUserOperationStatus",
						link: "/bundler/reference/endpoints/pimlico_getUserOperationStatus",
					},
				],
			},
			{
				...
				items: [
					{
						...
						link: "/bundler/reference/bundler-errors/invalid-api-key",
					},
					{
						text: "Chain is not supported",
						link: "/bundler/reference/bundler-errors/chain-not-supported",
					},
					{
						text: "Validation Error: Invalid Discriminator Value",
						link: "/bundler/reference/bundler-errors/invalid-discriminator-value",
					},
					{
						text: "Unknown error from alto bundler",
						link: "/bundler/reference/bundler-errors/unknown-error",
					},
				],
			},
			{
				...
				items: [
					{
						...
						link: "/bundler/reference/entrypoint-errors/aa10",
					},
					{
						text: "AA13 initCode failed or OOG",
						link: "/bundler/reference/entrypoint-errors/aa13",
					},
					{
						text: "AA14 initCode must return sender",
						link: "/bundler/reference/entrypoint-errors/aa14",
					},
					{
						text: "AA15 initCode must create sender",
						link: "/bundler/reference/entrypoint-errors/aa15",
					},
					...
					{ text: "AA25 invalid account nonce", link: "/bundler/reference/entrypoint-errors/aa25" },
					{
						...
						link: "/bundler/reference/entrypoint-errors/aa30",
					},
					{
						text: "AA31 paymaster deposit too low",
						link: "/bundler/reference/entrypoint-errors/aa31",
					},
					{
						text: "AA32 paymaster expired or not due",
						link: "/bundler/reference/entrypoint-errors/aa32",
					},
		...
		items: [
			{
				...
				items: [
					{
						text: "How to sponsor a User Operation",
						link: "/paymaster/verifying-paymaster/how-to/sponsor-a-user-operation",
					},
					{
						text: "How to use sponsorship policies",
						link: "/paymaster/verifying-paymaster/how-to/use-sponsorship-policies",
					},
				],
			},
			{
				...
				items: [
					{
						...
						link: "/paymaster/verifying-paymaster/reference/supported-chains",
					},
